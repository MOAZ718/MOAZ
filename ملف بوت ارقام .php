...
$token = "8283139563:AAGETYLHDeNAhkKPzV8nzv4IW-3jkLnpx0Q"#توكن بوتك 
define('API_KEY',$token);
date_default_timezone_set('Asia/Baghdad');
//-------------------------
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot8283139563:AAGETYLHDeNAhkKPzV8nzv4IW-3jkLnpx0Q/setWebhook?url=https://dev-mkskskdkskekk.pantheonsite.io/BOT/".API_KEY."/".$method;
    $ch = curl_init();
...
//==========================================//
                         ...
                         $admin = 7819366199; #ايدي الادمن 

                         $ch1 = "@AGl_H"; #معرف قناتك ب @

                         $ch2 = "AGl_H"; #معرف قناتك دون @
